...
public dataSave: any;
  ...
  constructor(public dialogRef: MatDialogRef<AddinfEstudianteComponent>,
    @Inject(MAT_DIALOG_DATA) public data: InAprendizajeEstuModel,
  ...
  addOpcion() {
    ...
    this.dataService.addData({'Activity_learning_reports':this.inEstuaprendizaje,'learning_reports':{'id':this.inEstuaprendizaje.inftutor.id}},'activitylearningreports')
      .subscribe( response => {
